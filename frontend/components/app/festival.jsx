                ...
                <div className="list-container">
                    <div className="movie-festival-container">
                        <div className="content-1">
                                <div className="custom-headings">Karawood History</div>
                                ...
                                <div className="content-2">
                                1- In order to submit a film, you must own the rights or have permission from the owner. <br/>
                                2- The Festival relationship will exclusively be related to the film submitter.<br/>
                                3- Any Foreign film that is not in English must have English subtitles.<br/>
                                4- All fees are non-refundable.<br/>
                                5- Kawarood will not be responsible for damaged copies.<br/>
                                6- Students must present a valid Student ID in order to receive our student discount.<br/>
                                7- Not all the submissions are selected for the official competition. Our Judges are free to make their own choices and no answers will be given about not selected films.<br/>
                                8- Kawarood can consider any film to be disqualified if the festival considers the content inappropriate.<br/>
                                9- Filmmakers can submit the film in multiple categories in order to become a multi-award film.<br/>
                                     Our Team may suggest the categories that are more suitable for the film to apply. Still, the decision about the selection is strictly determined by our judges' team and no selection is guaranteed.<br/>
                                10- A fee is required for the main category submission and also fees for additional categories. For payment structure visit (FilmFreeway website).<br/>
                                11- The applicants (submitters) must accept Kawarood Rules and Terms.<br/>
                                12- All submissions in personal categories required the name of the person and the category. You can easily send us this information in the cover letter at FilmFreeway website.<br/>
                                13- Submitting your movie, you authorize Kawarood to use, distribute and share the film poster, trailer, synopsis and movie stills in our social media.<br/>
                                14- Maximum length allowed is 40 minutes.<br/>
                                15- The annual prize of usd 3500 will be given once a year to the Best Short of the Year.<br/>
                                </div> 
